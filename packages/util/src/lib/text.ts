...
export const text: StaticUtility = {
    ...
    'break-normal ': {'utility': {'word-break': 'normal', 'overflow-wrap': 'normal'}, 'meta': {'group': 'wordBreak', 'order': 1}},
    'break-words ': {'utility': {'overflow-wrap': 'break-word'}, 'meta': {'group': 'wordBreak', 'order': 2}},
    'break-all ': {'utility': {'word-break': 'break-all'}, 'meta': {'group': 'wordBreak', 'order': 2}},
};